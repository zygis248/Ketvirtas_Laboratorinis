...
#define CLEAR_BUTTON_X1							70
#define CLEAR_BUTTON_Y1							290
#define CLEAR_BUTTON_X2						    CLEAR_BUTTON_X1 + 90
...
void Draw_Menu(){
  ...
  BSP_LCD_DisplayStringAt(0,250,(uint8_t*) "Pirmas spejimas:", LEFT_MODE);
  BSP_LCD_DisplayStringAt(0,270,(uint8_t*) "Antras spejimas:", LEFT_MODE);
  BSP_LCD_DrawRect(210,240,28,28);
  BSP_LCD_SetTextColor(LCD_COLOR_LIGHTCYAN);
  BSP_LCD_FillRect(70,290,90,50);
  BSP_LCD_SetTextColor(LCD_COLOR_RED);
  BSP_LCD_SetFont(&Font16);
  BSP_LCD_DisplayStringAt(0,300,(uint8_t*) "ISVALYTI", CENTER_MODE);
...
//  MX_SPI5_Init();
  ...
  //MX_X_CUBE_AI_Process();
	...
	if( BSP_PB_GetState(BUTTON_KEY)){
		...
		BSP_LCD_SetFont(&Font12);
		BSP_LCD_DisplayStringAt(120,250,(uint8_t*) first_guess_str, LEFT_MODE);
		BSP_LCD_DisplayStringAt(120,270,(uint8_t*) second_guess_str, LEFT_MODE);
		Reset_Pred(&in_data,&first_guess,&second_guess);
